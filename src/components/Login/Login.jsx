...
const Login = () => {
    return (
        <div className="bg-gray-50 min-h-screen flex items-center justify-center p-4">
            ...
            <h1 className="text-3xl font-extrabold text-gray-900 mb-1">Login Now!</h1>
            <p className="text-sm text-gray-500">Already have an account? 
                <Link to="/register" className="font-semibold text-purple-600 hover:text-purple-700 transition duration-150"> Register</Link>
            </p>
           </div>
           ...
           <div className="">
           <button className="btn bg-white text-black border-[#e5e5e5] w-full my-5 py-6">
